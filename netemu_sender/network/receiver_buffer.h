...
extern "C" {
	...
	struct netemu_receiver_buffer_item {
		...
		netlib_sockaddr *addr; /**< The address from the instruction was received. */
	...
	int netemu_receiver_buffer_add(struct netemu_receiver_buffer *buffer, struct application_instruction *instruction,
			netemu_connection_types type,  union netemu_connection_type connection, netlib_sockaddr* addr, int addr_size);

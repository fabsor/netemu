...
extern "C" {
   ...
   */
  void kailleraGetVersion(char *version);
   ...
   */
  void kailleraSetInfos(kailleraInfos *infos);
  /*
     kailleraSelectServerDialog:
     Use this method for launching the Kaillera server dialog
  */
  void kailleraSelectServerDialog(HWND parent);
